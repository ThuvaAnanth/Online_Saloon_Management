          ...
          <div class="containerHalf1">
              <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
                    <div class="loginPage" id="loginPage">
                         ...
                         <input type="email" class="username" placeholder="E-mail" name="emaill" required>
                         <input type="password" class="password" placeholder="Password" name="passwordd" required>
               ...
               <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="signupPage" id="signupPage" method="POST">
                         ...
                         <input type="date" class="signupInput" id="date" name="dob" required>
                         <input type="email" class="signupInput" placeholder="E-mail" name="email" required>
                         <input type="number" class="signupInput" placeholder="Contact-No" name="contactno" required>
                         <input type="text" class="signupInput" placeholder="User Name" name="username" required>
