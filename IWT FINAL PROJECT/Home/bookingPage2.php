           ...
           if(isset($_GET['time']))
                         {
                                   ...
                                   {
                                        $set = "INSERT INTO orderlist(serviceName,price,customerName,customerMail,employeeName ,sendDate,bookingDate,imagePath) VALUES('".$details1[0]."','DEPENDED','".$details2[5]."','".$details2[3]."','".$details1[3]."','".$date1."','".$_GET['date']." | ".$_GET['time']."','".$details1[4]."')";
